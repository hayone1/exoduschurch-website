...
data:
  ...
  - id: endue-with-power
    ...
    body: |
      ...
      “Bible study in the Kingdom”. Showing us the vitality of tongues in Ministry.
      Where is the “on high” ? What happened in Acts 2? These and more would be clarified.
      Dive in and listen
    bodyButtons:
  ...
  - id: grace-foreknowledge-predestination-and-election
    ...
    body: |
      ...
      Examining the events in Genesis1-3 carefully and how Moses writes Genesis. This would shape our understanding of these concepts. It’s not to be rushed. It’s a careful Teaching.
  ...
  - id: speedy-deliverance
    ...
    body: |
      ...
      shackles of satan. This excerpt will bless you. Share with a friend and more!🔥
    bodyButtons:
      - label: Listen
        color: neutral
